...
import { v as FiVideo, a2 as FiLogIn, y as FiUsers, c as FiCircle, a3 as FiHardDrive, a4 as FiTrendingUp, a5 as FiCalendar, s as FiClock, R as FiArrowRight, a6 as FiActivity, n as FiBell } from "../_libs/react-icons.mjs";
...
import { auth, notifications, meetings, analytics } from "./apiClient-BAZ_k_AE.mjs";
...
function Dashboard() {
  ...
  const [notifications$1, setNotifications] = reactExports.useState([]);
  const [liveRecent, setLiveRecent] = reactExports.useState([]);
  const [liveUpcoming, setLiveUpcoming] = reactExports.useState([]);
  const [analytics$1, setAnalytics] = reactExports.useState([{
  ...
  const displayUser = sessionUser ? {
    ...
    initials: (sessionUser.fullName || sessionUser.username || sessionUser.email || "U").slice(0, 2).toUpperCase(),
  ...
  const unread = notifications$1.filter((n) => !n.read).length;
  reactExports.useEffect(() => {
    ...
    meetings.getRecent().then((data) => {
      if (data?.length) {
        setLiveRecent(data.map((m) => ({
          id: m.meetingId || m.id,
          title: m.title,
          date: m.actualStartTime ? new Date(m.actualStartTime).toLocaleDateString() : "",
          duration: m.actualEndTime && m.actualStartTime ? `${Math.round((new Date(m.actualEndTime).getTime() - new Date(m.actualStartTime).getTime()) / 6e4)} min` : "Ongoing",
    ...
    meetings.getUpcoming().then((data) => {
      if (data?.length) {
        setLiveUpcoming(data.map((m) => ({
          id: m.meetingId || m.id,
          title: m.title,
          time: m.scheduledStartTime ? new Date(m.scheduledStartTime).toLocaleTimeString() : "",
          relative: "Scheduled",
          host: m.hostName || "Host",
          participants: m.maxParticipants || 0
        })));
      }
    }).catch(() => {
    });
    analytics.getDashboard().then((data) => {
      if (data) {
        const mapped = [{
          ...
          label: "Avg. duration",
          value: `${data.avgDurationMin || 0}m`,
          trend: "+5%",
          spark: [20, 35, 28, 40, 35, 45, 42]
        }, {
          label: "Participants",
          value: `${data.totalParticipants || 0}`,
          trend: "+8%",
          spark: [10, 15, 12, 18, 16, 20, 22]
        }];
        setAnalytics(mapped);
      }
    }).catch(() => {
    });
    import("./apiClient-BAZ_k_AE.mjs").then(({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AppShell, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { variants: stagger, initial: "hidden", animate: "show", className: "space-y-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: item, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Panel, { title: "Workspace status", icon: FiUsers, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-between gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grid h-12 w-12 place-items-center rounded-2xl bg-gradient-primary text-base font-semibold text-primary-foreground", children: workspace.name.slice(0, 2).toUpperCase() }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold", children: workspace.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: workspace.plan })
            ] })
          ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 grid grid-cols-3 gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { icon: FiUsers, label: "Members", value: `${workspace.members}` }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { icon: FiVideo, label: "Active rooms", value: `${workspace.activeRooms}` }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { icon: FiHardDrive, label: "Storage", value: `${workspace.storageUsed}%` })
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: item, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Panel, { title: "Meeting analytics", icon: FiTrendingUp, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-4 sm:grid-cols-3", children: analytics$1.map((a) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-interactive rounded-xl border border-border bg-background/50 p-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: item, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Panel, { title: "Upcoming meetings", icon: FiCalendar, action: {
        label: "Schedule",
        to: "/history"
      }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-3 sm:grid-cols-2", children: liveUpcoming.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setPreview({
        title: m.title,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-5 lg:grid-cols-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: item, className: "lg:col-span-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Panel, { title: "Recent meetings", icon: FiClock, action: {
          label: "View all",
          to: "/history"
        }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: liveRecent.slice(0, 4).map((m) => /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setPreview({
          title: m.title,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: item, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Panel, { title: "Activity", icon: FiActivity, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: notifications$1.slice(0, 4).length > 0 ? notifications$1.slice(0, 4).map((n) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mt-1 h-2 w-2 shrink-0 rounded-full bg-accent" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", children: n.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: n.time })
          ] })
        ] }, n.id)) : liveRecent.slice(0, 4).map((m) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mt-1 h-2 w-2 shrink-0 rounded-full bg-primary" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm", children: [
              "Meeting: ",
              m.title
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: m.date })
          ] })
        ] }, m.id)) }) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: item, className: "lg:col-span-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Panel, { title: "Notifications", icon: FiBell, action: {
          label: "Open",
          to: "/notifications"
        }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: notifications$1.slice(0, 3).map((n) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 rounded-xl border border-border bg-background/50 p-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: item, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Panel, { title: "Your profile", icon: FiUsers, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grid h-12 w-12 place-items-center rounded-full bg-gradient-primary text-base font-semibold text-primary-foreground", children: displayUser.initials }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold", children: displayUser.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: displayUser.role })
            ] })
          ] }),

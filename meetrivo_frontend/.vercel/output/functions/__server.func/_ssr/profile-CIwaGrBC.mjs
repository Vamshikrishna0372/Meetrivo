...
import { v as FiVideo, s as FiClock, M as FiLayers, h as FiLoader, F as FiEdit2 } from "../_libs/react-icons.mjs";
...
import { analytics, users, BACKEND_BASE_URL } from "./apiClient-DSVPR1M2.mjs";
...
function ProfilePage() {
  ...
  const [uploadingPic, setUploadingPic] = reactExports.useState(false);
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 space-y-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative overflow-hidden rounded-3xl border border-border bg-card p-6 sm:p-8", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-4 text-center sm:flex-row sm:text-left", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative group shrink-0 h-20 w-20", children: [
            profile?.profilePicture ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: profile.profilePicture.startsWith("http") ? profile.profilePicture : `${BACKEND_BASE_URL}${profile.profilePicture}`, alt: profile.fullName || profile.username, className: "h-20 w-20 rounded-full object-cover shadow-glow border border-primary/20" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grid h-20 w-20 place-items-center rounded-full bg-gradient-primary text-2xl font-bold text-primary-foreground shadow-glow", children: initials }),
            uploadingPic ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center bg-black/60 rounded-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FiLoader, { className: "h-5 w-5 animate-spin text-white" }) }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "absolute inset-0 flex items-center justify-center bg-black/60 text-white rounded-full opacity-0 group-hover:opacity-100 cursor-pointer transition-opacity text-xs font-semibold", children: [
              "Change",

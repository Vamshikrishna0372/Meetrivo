...
import { Z as FiUser, v as FiVideo, p as FiShield, _ as FiChevronLeft, h as FiLoader, i as FiCheck, q as FiLock, H as FiCopy } from "../_libs/react-icons.mjs";
...
import { auth, meetings } from "./apiClient-DhOx7IPH.mjs";
...
function CreateMeeting() {
  ...
  const roomId = createdMeeting?.meetingCode || "";
  const link = roomId ? typeof window !== "undefined" ? `${window.location.origin}/lobby?code=${roomId}` : `https://meetrivo.com/j/${roomId}` : "";

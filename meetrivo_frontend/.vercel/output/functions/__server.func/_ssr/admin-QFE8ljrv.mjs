...
import { aa as FiActivity, y as FiUsers, v as FiVideo, k as FiHelpCircle, a2 as FiFileText, V as FiSettings, h as FiLoader, ad as FiDatabase, ae as FiDollarSign, g as FiTrash2 } from "../_libs/react-icons.mjs";
import { A as AppShell } from "./AppShell-DbHoEmQv.mjs";
import { B as Button } from "./button-ZuR0Bnki.mjs";
import { admin, support } from "./apiClient-DhOx7IPH.mjs";
...
function AdminPage() {
  ...
  const [userRoleFilter, setUserRoleFilter] = reactExports.useState("");
  const [userStatusFilter, setUserStatusFilter] = reactExports.useState("");
  const [userPage, setUserPage] = reactExports.useState(1);
  const usersPerPage = 10;
  const [selectedUsers, setSelectedUsers] = reactExports.useState([]);
  const [selectedUserDetails, setSelectedUserDetails] = reactExports.useState(null);
  ...
  const [systemAnalytics, setSystemAnalytics] = reactExports.useState(null);
  const [selectedUserAnalytics, setSelectedUserAnalytics] = reactExports.useState(null);
  const [selectedUserLoginHistory, setSelectedUserLoginHistory] = reactExports.useState(null);
  ...
  reactExports.useEffect(() => {
    if (selectedUserDetails) {
      admin.getUserAnalytics(selectedUserDetails.id).then((res) => setSelectedUserAnalytics(res)).catch(() => setSelectedUserAnalytics(null));
      admin.getUserLoginHistory(selectedUserDetails.id).then((res) => setSelectedUserLoginHistory(res)).catch(() => setSelectedUserLoginHistory(null));
    } else {
  ...
  const handleUserAction = async (userId, action, payload, skipReload) => {
    try {
      if (action === "delete") {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AppShell, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-[400px]", children: loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-64 items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FiLoader, { className: "h-8 w-8 animate-spin text-primary" }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
      ...
      activeTab === "users" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row gap-4 justify-between items-start md:items-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2 items-center w-full md:w-auto", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", placeholder: "Search users...", value: userSearch, onChange: (e) => {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { value: userRoleFilter, onChange: (e) => {
              setUserRoleFilter(e.target.value);
              setUserPage(1);
            }, className: "bg-surface text-sm rounded-lg px-3 py-2 border border-border outline-none focus:border-primary/50", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "ORGANIZATION_OWNER", children: "Org Owner" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "ORGANIZATION_ADMIN", children: "Org Admin" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "TEAM_MANAGER", children: "Team Manager" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "MEMBER", children: "Member" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "GUEST", children: "Guest" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { value: userStatusFilter, onChange: (e) => {
          ...
          selectedUsers.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 bg-primary/10 px-3 py-2 rounded-lg border border-primary/20", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm font-semibold text-primary", children: [
              selectedUsers.length,
              " selected"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => handleBulkAction("activate"), className: "text-xs bg-success text-white px-2 py-1 rounded", children: "Activate" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => handleBulkAction("deactivate"), className: "text-xs bg-warning text-white px-2 py-1 rounded", children: "Deactivate" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => handleBulkAction("delete"), className: "text-xs bg-destructive text-white px-2 py-1 rounded", children: "Delete" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl border border-border bg-card overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "border-b border-border bg-surface/50 text-xs font-semibold uppercase text-muted-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-5 py-3.5 w-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "checkbox", onChange: handleSelectAllUsers, checked: displayedUsers.length > 0 && selectedUsers.length === displayedUsers.length }) }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { className: "divide-y divide-border/60", children: [
            displayedUsers.map((u) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "hover:bg-surface/30", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-5 py-3.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "checkbox", checked: selectedUsers.includes(u.id), onChange: () => toggleUserSelection(u.id) }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-5 py-3.5 cursor-pointer", onClick: () => setSelectedUserDetails(u), children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground hover:text-primary transition-colors", children: u.fullName || "Unnamed User" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-5 py-3.5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { value: u.role || "MEMBER", onChange: (e) => handleUserAction(u.id, "role", e.target.value), className: "bg-surface text-xs font-semibold rounded px-2.5 py-1 border border-border outline-none cursor-pointer", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "SUPER_ADMIN", children: "SUPER_ADMIN" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "ORGANIZATION_OWNER", children: "ORG_OWNER" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "ORGANIZATION_ADMIN", children: "ORG_ADMIN" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "TEAM_MANAGER", children: "TEAM_MANAGER" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "MEMBER", children: "MEMBER" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "GUEST", children: "GUEST" })
              ] }) }),
            ...
            displayedUsers.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: 6, className: "px-5 py-8 text-center text-muted-foreground", children: "No users found." }) })
          ] })
        ] }) }) }),
        totalUserPages > 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setUserPage((p) => Math.max(1, p - 1)), disabled: userPage === 1, className: "px-3 py-1.5 text-sm bg-surface border border-border rounded-lg disabled:opacity-50", children: "Prev" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setUserPage((p) => Math.min(totalUserPages, p + 1)), disabled: userPage === totalUserPages, className: "px-3 py-1.5 text-sm bg-surface border border-border rounded-lg disabled:opacity-50", children: "Next" })
          ] })
        ] }),
        selectedUserDetails && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-background/80 backdrop-blur-sm p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-2xl w-full max-w-md p-6 relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setSelectedUserDetails(null), className: "absolute top-4 right-4 text-muted-foreground hover:text-foreground", children: "✕" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold mb-4", children: "User Details" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 text-sm max-h-[70vh] overflow-y-auto pr-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground font-medium", children: "Name:" }),
              " ",
              selectedUserDetails.fullName
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground font-medium", children: "Email:" }),
              " ",
              selectedUserDetails.email
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground font-medium", children: "Username:" }),
              " @",
              selectedUserDetails.username
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground font-medium", children: "Role:" }),
              " ",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground font-medium", children: "Joined:" }),
              " ",
              new Date(selectedUserDetails.createdAt).toLocaleDateString()
            ] }),
            selectedUserAnalytics && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 pt-4 border-t border-border/50", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold text-foreground mb-2", children: "Meeting Analytics" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2 text-xs", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-surface p-2 rounded", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "Hosted:" }),
                  " ",
                  selectedUserAnalytics.hostedMeetings
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-surface p-2 rounded", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "Joined:" }),
                  " ",
                  selectedUserAnalytics.joinedMeetings
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-surface p-2 rounded", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "Duration:" }),
                  " ",
                  selectedUserAnalytics.meetingMinutes,
                  " min"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-surface p-2 rounded", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "Avg Time:" }),
                  " ",
                  selectedUserAnalytics.avgDurationMinutes,
                  " min"
                ] })
              ] })
            ] }),
            selectedUserLoginHistory && selectedUserLoginHistory.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 pt-4 border-t border-border/50", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold text-foreground mb-2", children: "Recent Logins" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: selectedUserLoginHistory.slice(0, 5).map((log, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-xs bg-surface p-2 rounded", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: new Date(log.loginTime).toLocaleString() }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `px-1.5 py-0.5 rounded text-[10px] font-medium ${log.status === "SUCCESS" ? "bg-success/15 text-success" : "bg-destructive/15 text-destructive"}`, children: log.status })
              ] }, i)) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pt-4 border-t border-border mt-4 flex justify-end gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setSelectedUserDetails(null), className: "px-4 py-2 bg-surface hover:bg-surface/80 transition-colors rounded-lg font-medium", children: "Close" }) })
          ] })
        ] }) })
      ] }),

...
import { E as FiCheckCircle, r as FiVideoOff, i as FiMic, p as FiMicOff, q as FiVideo, G as FiVolume2, H as FiSettings } from "../_libs/react-icons.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex flex-1 items-center justify-center px-4 py-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid w-full max-w-4xl gap-6 lg:grid-cols-[1.4fr_1fr]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 grid place-items-center", children: camOn ? /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grid h-24 w-24 place-items-center rounded-full bg-gradient-primary text-3xl font-bold text-primary-foreground shadow-glow", children: currentUser.initials }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-auto space-y-2 pt-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "hero", size: "lg", className: "w-full", onClick: () => navigate({
            to: "/room"
          }), children: "Join now" }),

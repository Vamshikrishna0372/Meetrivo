...
import { v as FiVideo, a6 as FiLogIn, y as FiUsers, c as FiCircle, a7 as FiHardDrive, a8 as FiTrendingUp, a9 as FiCalendar, s as FiClock, X as FiArrowRight, aa as FiActivity, n as FiBell } from "../_libs/react-icons.mjs";
...
import { auth, notifications, meetings, analytics } from "./apiClient-DhOx7IPH.mjs";
...
function Dashboard() {
  ...
  reactExports.useEffect(() => {
    ...
    meetings.getRecent().then((data) => {
      if (data?.length) {
        setLiveRecent(data.map((m) => ({
          ...
          duration: m.actualEndTime && m.actualStartTime ? `${Math.round((new Date(m.actualEndTime).getTime() - new Date(m.actualStartTime).getTime()) / 6e4)} min` : m.duration ? `${m.duration} min` : "Ongoing",
    ...
    import("./apiClient-DhOx7IPH.mjs").then(({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AppShell, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: !!preview, onOpenChange: (o) => !o && setPreview(null), children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogContent, { className: "max-w-md", children: preview && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "hero", className: "w-full", asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: `/room?meetingId=${preview.id}`, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(FiVideo, {}),
          " ",

import { q as FiVideo, aa as FiCode, S as FiGrid, u as FiMessageSquare, a3 as FiEdit3, ab as FiSmartphone } from "../_libs/react-icons.mjs";
const features = [
  {
    icon: FiVideo,
...
export {
  ...
  reactionEmojis as r,
  sharedFiles as s,
  upcomingMeetings as u,
  workspaceStatus as w
};
